 ...
 */
class Model_Jacksonville extends Model_Scrape
{
    private $scrape     = 'jacksonville'; //name of scrape goes here
	private $county 	= 'jacksonville'; // if it is a single county, put it here, otherwise remove this property
    private $state      = 'jacksonville'; // state goes here
    private $cookies    = '/tmp/jacksonville_cookies.txt'; // replace with <scrape name>_cookies.txt
    ...
    */
    function curl_index()
    {
        ...
        $url = 'http://inmatesearch.jaxsheriff.org/%28a1zi2255inwwm255r0cnl245%29/Default.aspx';  // this will be the url to the index page
        $ch = curl_init();   
