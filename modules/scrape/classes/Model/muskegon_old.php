 ...
 */
class Model_OldMuskegon extends Model_Scrape
{
    ...
    function scrape() 
    {
        ...
        $cookies = DOCROOT.'public/cookiejar/muskegon_cookie.txt';
        if ( file_exists($cookies) ) { unlink($cookies); } //delete cookie file if it exists       
