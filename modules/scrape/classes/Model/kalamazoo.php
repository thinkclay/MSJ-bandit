...
class Model_Kalamazoo extends Model_Scrape
{
    ...
    public function __construct()
    {
    	...
    	$this->remove = array(
			...
			// This is another offender that we skip with a photo but no info, just to test if the scrape will run correctly.
			'BENSON, TERRI ELLEN'
		);
    ...
    */
    function scrape() 
    {
		...
		$file = $this->path . "kalamazoo_report.pdf";
		...
		$html_file = $this->path . 'kalamazoo_reports.html';
