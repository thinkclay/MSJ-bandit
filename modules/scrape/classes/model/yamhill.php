 ...
 * @package Scrape
 * @author Bryan Galli
 * @url http://www.co.yamhill.or.us/sheriff/inmates/icurrent.htm
 */
class Model_Yamhill extends Model_Scrape
{
    private $scrape     = 'yamhill';
    private $state      = 'oregon';
    private $cookies    = '/tmp/yamhill_cookies.txt';
    ...
    */
    ...
    {
    	$county = 'yamhill';
    	$home_url = 'http://www.co.yamhill.or.us/sheriff/inmates/icurrent.htm';
