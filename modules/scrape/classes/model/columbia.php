 ...
 * @package Scrape
 * @author Bryan Galli
 * @url http://www.co.columbia.or.us/sheriff/inmates/
 */
class Model_Columbia extends Model_Scrape
{
    private $scrape     = 'columbia';
    private $state      = 'oregon';
    private $cookies    = '/tmp/columbia_cookies.txt';
    ...
    */
    ...
    {
    	$county = 'columbia';
    	$home_url = 'http://www.co.columbia.or.us/sheriff/inmates/';
    ...
    */
    ...
    {
    	$theurl = "http://www.co.columbia.or.us/sheriff/inmates/" . $offender_link;
			...
			if(!$offender->loaded())
			{
				...
				if($check)
				{
					...
					if($check)
					{
						...
						$check = preg_match('/\<\/b\>.*Booking\sDate\:\s\<b\>(.*)\</Uis', $details_page, $booking_date);
						if($check)
						{
							...
							if($check)
							{
								...
								if($image_id == 'NOPIC.JPG')
									return 101;
								$image_link = 'http://www.co.columbia.or.us/sheriff/inmates/' . $image_id;
