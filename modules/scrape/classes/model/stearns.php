 ...
 */
class Model_Stearns extends Model_Scrape
{
    ...
    */
    function extraction($details, $booking_id)
    {
		...
		$check = preg_match('/\<img\ssrc\=\"(http\:\/\/www\.clickcomplete\.com\/jail\/jmsimages.*)\".*class\=\"inmate\_pic\_found\"/Uis', $details, $match);
		if ( ! $check)
		{
			return 102;
		}
